...
try {
  ...
  npx --yes '@google/clasp@3' list-scripts | Set-Content -LiteralPath before-scripts.txt -Encoding utf8
  ...
  npx --yes '@google/clasp@3' list-scripts | Set-Content -LiteralPath after-scripts.txt -Encoding utf8
  ...
  Remove-Item -LiteralPath before-scripts.txt,after-scripts.txt -Force -ErrorAction SilentlyContinue
