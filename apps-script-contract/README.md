...
└── 전자계약/
    ...
    ├── MM-2026-0143 김영희/
    └── 백업/
        ├── 계약백업_2026-07-30_0300.json
        └── 계약백업_2026-07-31_0300.json
```
...
| --- | --- | --- | --- |
| **비용** | 서버·볼륨 유지비가 매달 나감 | **결제계정이 없을 때만 무료** | 좋아짐 |
...
| **하루 사용량 한도** | 없음 | 있음(수치는 [SETUP.md 11장](./SETUP.md) 참고) | **나빠짐** |
...
언제 옮겨야 하는지는 [SETUP.md 12장](./SETUP.md)에 적었습니다.
