...
const OLD_HASH = 'd20b62baadb95b055047d05949bd040e6c143e8db44ad87c0846225f1cc54e85'; // 39 public objects: the 38 pinned after the Nonsan Gangsan name correction (2026-09-09) + the 평화로운아파트 leak case rewritten from the 2026-09-09 photos (insights[0]); other prose unchanged.
